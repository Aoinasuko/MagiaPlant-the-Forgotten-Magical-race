...
{
	public class MagiaPlant_Settings : Mod
	{
		public MagiaPlant_Settings(ModContentPack content) : base(content)
		{
			GetSettings<MagiaPlant_Config>();
		}

		public override string SettingsCategory()
		{
			return "MagiaPlant.Config.Title".Translate();
		}

		public override void DoSettingsWindowContents(Rect inRect)
		{
			MagiaPlant_Config.DoWindowContents(inRect);
		}
	}
	...
	public class MagiaPlant_Config : ModSettings
	{
		...
		public static void DoWindowContents(Rect inRect)
		{
			...
			if (listingStandard.ButtonText("MagiaPlant.Config.Update".Translate()))
			{
				Updatever = ver;
